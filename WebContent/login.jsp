...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/user_login.action" target="_parent" onsubmit="javascript:return WebForm_OnSubmit();" method=post>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD>
	               <input id=btn 
	                  style="width: 105px;BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" 
	              ...
	              <td>
	              <input 
	                  style="background: url(images/regist_button.gif) no-repeat;width: 105px;height: 37px;
	                  		border: none;BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" 
	                  type=button onclick="registUI()"/></td>
                <tr><s:actionerror/><tr>
