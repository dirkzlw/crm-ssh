										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>拜访时间：从</TD>
													<TD>
														<input type="text" id="visit_time" name="visit_time" value="<s:date name="visit_time" format="yyyy-MM-dd"/>" readonly="true"/>
													</TD>
													
													<TD>到</TD>
													<TD>
														<input type="text" id="visit_end_time" name="visit_end_time" value="<s:date name="visit_end_time" format="yyyy-MM-dd"/>" readonly="true"/>
													</TD>
